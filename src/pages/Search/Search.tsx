...
export function Search() {
    ...
    async function getResult() {
        try {
            if (!q || !type || !params.page || !order || !direction) {
                ...
                if (page > 1 && page > response.data.metadata.pageCount) {
    ...
    return (
        result && <div className="my-4 w-full">
            ...
            {result.threads && result.threads.map((thread: any) => (
                <div className="mt-4">
            ...
            {result.users && <div className="flex gap-4 mt-4 flex-wrap">
                {result.users.map((user: any) => (
                    <div className="bg-body-secondary inline-flex flex-col rounded-lg p-4 text-center">
