...
export function SearchBar() {
    ...
    return (
        <form className="flex" onSubmit={async (e) => {
            ...
            <input className="rounded-s-md rounded-e-none bg-light text-nowrap w-full" type="search" placeholder="Keywords..." aria-label="Search" onChange={(e) => setSearchInput(e.target.value)}/>
